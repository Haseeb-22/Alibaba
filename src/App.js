...
function App() {
  const [images, setImage] = useState([
    {
      img: "https://s.alicdn.com/@img/tfs/TB1hVGkvVP7gK0jSZFjXXc5aXXa-365-49.svg",
    },
  ]);
  ...
  let getCategories = () => {
    let list = listData.map((x) => x.category);
    list = [...new Set([...list])];
  ...
  let searchCategory = (val) => {
    ...
    let filterdlist = listData.filter((x) => x.category == val);
  ...
  return (
    <div className="App">
      <AppBar sx={{ height: "53px", backgroundColor: "white" }}>
        <Container>
          <Grid container spacing={8}>
            <Grid
              ...
              xs={12}
              sm={6}
              sx={{ marginTop: "15px", paddingLeft: "8px" }}
            >
            ...
            <Grid item md={4} xs={12} sm={6} sx={{ height: "1px" }}>
              <Box>
                <TextField
                  id="filled-search"
                  fullWidth={true}
            ...
            >
              ...
              <ChatRoundedIcon sx={{ color: "black" }} /> &nbsp;
